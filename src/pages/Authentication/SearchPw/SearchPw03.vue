<template>
  <div class="search-title">
      ...
      <div class="group">
        <div class="sub-content">
          ...
          <input
            ...
            v-model="bizNumber"
          />
          <span class="eye-icon" @mousedown.prevent @click="togglePassword">
            <img
              v-if="showFirst"
        ...
        <div class="sub-content">
          <label for="bizNumber2" class="biz-number">비밀번호 재확인</label>
          <input
            id="bizNumber2"
          ...
          <span class="eye-icon2" @mousedown.prevent @click="togglePassword2">
            <img
              v-if="showFirst2"
              src="/src/assets/img/icon/eyeClose.svg"
              alt="eyeCloseImg"
    ...
    <SearchAlert v-if="isModalOpen" @close="isModalOpen = false" />
  </div>
</template>
...
import SearchAlert from './SearchAlert/SearchAlert.vue';
...
/* 적용 요청된 focus-within 스타일만 추가 */
.search-title .agreement .group .sub-content:focus-within .biz-number {
  color: #2866ec;
}
.search-title .agreement .group .sub-content:focus-within .biz-input,
.search-title .agreement .group .sub-content .biz-input:focus {
  border-color: #2866ec;
  outline: none;
}
