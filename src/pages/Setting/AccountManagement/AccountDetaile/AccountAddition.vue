<template>
  <div class="wrap">
    ...
    <div class="con con01">
      ...
      <ul>
        <li>
          ...
          <input type="text" id="con01-1" placeholder="adminID9999" />
        </li>
        <li class="position">
          <label for="con01-2" class="input-box">비밀번호</label>
          <input
    ...
    <div class="con con02">
      ...
      <ul>
        <li>
          ...
          <input type="text" id="con02-1" placeholder="서브 계정명00002" />
        </li>
        <li>
          <label for="con02-2" class="input-box">점주명</label>
          <input type="text" id="con02-2" placeholder="김점주" />
        </li>
        <li>
    ...
    <button class="bottom-btn" @click="goNextPage">계정추가</button>
  </div>
</template>
