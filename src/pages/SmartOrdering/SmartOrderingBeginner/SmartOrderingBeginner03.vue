<template>
  ...
  <div class="wrap">
    <div class="con con01">
      <h1>Step. 3</h1>
      <p>회원님에게 맞춤 서비스 제공을 위해</p>
      <span> 유형에 맞게 설정해주세요.</span>
    </div>
    <div class="con con02">
      <div class="title">구매 예정 자본</div>
      <ul>
        <li>100만원 이하</li>
        <li>100만원 ~ 500만원</li>
        <li>500만원 이상</li>
...
function goBackPage() {
  router.push('/smartorderingbeginner02');
}

function goNextPage() {
  router.push('/smartorderingbeginner04');
}
