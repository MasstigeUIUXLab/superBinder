      ...
      <ul class="method-list">
        <li>
          <div class="method-card">
            ...
            />
            <div class="bank-info">
              <p class="bank-name">카카오 뱅크</p>
              <p class="bank-account">123*********388</p>
            </div>
            <button type="button" class="method-action"></button>
          </div>
        </li>
        <li>
          <div class="method-card">
            <img
              src="/src/assets/img/bankLogo/tos.svg"
              alt="토스스 로고"
              class="bank-logo"
            />
            <div class="bank-info">
        ...
        <li>
          <div class="method-card-flus">
            <img
              src="/src/assets/img/icon/bankFlus.svg"
              alt="카카오뱅크 로고"
              class="bank-logo+flus"
            />
            <p class="bank-flus-btn">카카오 뱅크</p>
          </div>
        </li>
      </ul>
    </div>
